(() => {
    ...
    (() => {
        ...
        function formRating() {
            ...
            function initRatings() {
                ...
                function setRating(rating) {
                    const ratingItems = rating.querySelectorAll(".rating__ite");
        ...
        function initSliders() {
            if (document.querySelector(".popular-regions__slider")) new core(".popular-regions__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                preloadImages: true,
                navigation: {
                    prevEl: ".popular-regions__prev",
                    nextEl: ".popular-regions__next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".users-say__slider")) new core(".users-say__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                preloadImages: true,
                navigation: {
                    prevEl: ".users-say__prev",
                    nextEl: ".users-say__next"
                },
                breakpoints: {
                    590: {
                        slidesPerView: 1,
        ...
        var script_element = document.getElementById("menu__top-more");
        var script_trigger = document.getElementById("more-country");
        script_trigger.addEventListener("click", (function(e) {
            e.preventDefault();
            script_element.classList.toggle("menu__top-more--active");
            function menuCloseClickOutside(e) {
                if (!e.target.matches(".top-more__item *, .menu__body-top-link *, .top-more *")) menuClose();
            }
            function menuClose() {
                script_element.classList.remove("menu__top-more--active");
            }
